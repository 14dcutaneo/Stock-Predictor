...
public class Graphpannel extends JPanel {
    ...
    private double[] pastScores;
    private String name;

    public Graphpannel(double[] scores, String n) {
        this.scores = scores;
        this.name = n;
    }
...
//    }
    ...
    public void passMe(double [] array)
    {
     ...
     public void createAndShowGui(double[] numbers,String tick) {
    	/*
