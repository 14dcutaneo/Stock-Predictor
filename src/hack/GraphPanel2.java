...
public class GraphPanel2 extends JPanel {
    ...
    private static double[] pastScores;
    private static String name;

    public GraphPanel2(double[] scores, String n) {
        this.scores = scores;
        this.name = n;
    }
...
//    }
    ...
    public void passMe(double [] array)
    {
    	this.scores = array;
    }

     public static void createAndShowGui(double[] numbers, String tick) {
    	/*
...
//            scores.add((double) i);
        ...
        Graphpannel mainPanel = new Graphpannel(numbers, tick);
...
/*
    public static void main(String[] args) 
    {
      ...
      System.out.println("Hello!");
		...
		PeicewiseStep p = new PeicewiseStep(new Tween(5,10), new LinearModel(2,0));

		Scanner in = new Scanner(System.in);
		System.out.println("Enter TCKR");
		System.out.print("> ");
		String tick = in.next();
		StockViewer k = new StockViewer(tick);
